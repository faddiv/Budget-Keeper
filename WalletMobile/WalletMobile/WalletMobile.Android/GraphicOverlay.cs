...
namespace WalletMobile.Droid
{
     ...
     */
         ...
         */
            ...
            /// <summary>
            /// Returns a RectF in which the left and right parameters of the provided Rect are adjusted by translateX, and the top and bottom are adjusted by translateY.
            /// </summary>
            ...
            public RectF TranslateRect(RectF inputRect)
            {
                ...
                {
                    Left = TranslateX(inputRect.Left),
                    Top = TranslateY(inputRect.Top),
                    Right = TranslateX(inputRect.Right),
                    Bottom = TranslateY(inputRect.Bottom)
                };
