...
export class TransactionTableRow extends React.Component<TransactionTableRowProps, TransactionTableRowState> {
    ...
    changeDirection(event: React.MouseEvent<HTMLTableDataCellElement>) {
        ...
        this.setState((prevState) => {
            return {
                item: { ...prevState.item, direction: nextDirection(prevState.item.direction || 0) }
            };
        });
    }
    ...
    renderEditRow() {
        ...
        const { rowColor, selected } = this.props;
        ...
        return (
            <tr className={classNames(actualRowColor, { selected })} onChange={this.handleInputChange}
                ...
                <td onClick={this.changeDirection} onMouseDown={preventDefault}>
                    <DirectionIcon direction={item.direction || 0} />
                </td>
                <td>
    ...
    renderViewRow() {
        ...
        const actualRowColor = rowColor && rowColor(item);
        return (
            <tr className={classNames(actualRowColor, { selected })}
                onMouseDown={this.startSelection} onMouseEnter={this.continueSelection} onMouseUp={this.endSelection}>
